defmodule CarsCommercePuzzleAdventureWeb.CoreComponents do
  @moduledoc """
  ...
  @doc """
  Renders a basic modal. Similar to modal, but the modal cannot be closed by the client.
  """
  attr(:id, :string, required: true)
  attr(:show, :boolean, default: false)
  slot(:inner_block, required: true)
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CarsCommercePuzzleAdventureWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CarsCommercePuzzleAdventureWeb.Gettext, "errors", msg, opts)
    end
  end
